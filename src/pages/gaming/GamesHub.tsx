...
import { Puzzle, Brain, Zap, Dices, Clock, ArrowLeft } from 'lucide-react';
...
const GamesHub = () => {
  ...
  const games = [
    ...
    },
    {
      ...
      comingSoon: false,
      component: <div className="text-center py-8">Reflex Challenge Game Coming Soon!</div>
    },
    {
      id: 'puzzle',
      title: 'Number Puzzle',
  ...
  const selectedGame = id ? games.find(game => game.id === id) : null;
            ...
            <motion.div variants={itemVariants}>
              <div className="flex items-center mb-6">
                ...
                <h1 className="text-2xl md:text-3xl font-bold flex items-center">
                  {selectedGame.icon}
                  <span className="ml-2">{selectedGame.title}</span>
                </h1>
              </div>
                ...
                <CardContent className="p-6">
                  {selectedGame.comingSoon ? (
                    <div className="text-center py-16">
                      ...
                      <p className="text-gray-600 mb-6">This game is currently in development.</p>
                      <Button variant="outline" onClick={() => navigate('/gaming/games')}>
                        Return to Games Hub
                      </Button>
                    </div>
                  ) : (
